...
USE ROLE ACCOUNTADMIN;
        ...
        ALTER SNOWFLAKE INTELLIGENCE SNOWFLAKE_INTELLIGENCE_OBJECT_DEFAULT 
          DROP AGENT INS_CO.LOSS_CLAIMS.CLAIMS_AUDIT_AGENT;

CREATE OR REPLACE PROCEDURE INS_CO.LOSS_CLAIMS.ADD_AGENT_TO_INTELLIGENCE()
RETURNS VARCHAR
LANGUAGE SQL
EXECUTE AS CALLER
AS
...
BEGIN
    ...
    ALTER SNOWFLAKE INTELLIGENCE SNOWFLAKE_INTELLIGENCE_OBJECT_DEFAULT 
      ADD AGENT INS_CO.LOSS_CLAIMS.CLAIMS_AUDIT_AGENT;
    
    RETURN 'Agent added successfully to Snowflake Intelligence';
END;
$$;

CALL INS_CO.LOSS_CLAIMS.ADD_AGENT_TO_INTELLIGENCE();

SELECT 'Agent configured successfully!' as message;