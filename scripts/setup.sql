...
CREATE OR REPLACE DATABASE INS_CO;

-- Grant all privileges on the database to the role
GRANT ALL ON DATABASE INS_CO TO ROLE CLAIMS_AGENT_ROLE;

CREATE OR REPLACE SCHEMA INS_CO.LOSS_CLAIMS;

-- Grant all privileges on the schema to the role
GRANT ALL ON SCHEMA INS_CO.LOSS_CLAIMS TO ROLE CLAIMS_AGENT_ROLE;
...
GRANT CREATE AGENT ON SCHEMA INS_CO.LOSS_CLAIMS TO ROLE CLAIMS_AGENT_ROLE;
...
CREATE OR REPLACE STAGE INS_CO.LOSS_CLAIMS.LOSS_EVIDENCE 
